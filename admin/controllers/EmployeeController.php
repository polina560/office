 ...
 */
final class EmployeeController extends AdminController
{
    /**
     * {@inheritdoc}
     */
...
//        Yii::$app->getClientScript()->registerCoreScript('js/map');
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            ...
            return match ($redirect) {
                ...
                'index' => $this->redirect(UserUrl::setFilters(EmployeeSearch::class)),
    ...
    public function actionDelete(int $id): Response
    {
        ...
        return $this->redirect(UserUrl::setFilters(EmployeeSearch::class));
    }
     ...
     * @throws NotFoundHttpException if the model cannot be found
     */
    private function findModel(int $id): Employee
    {
